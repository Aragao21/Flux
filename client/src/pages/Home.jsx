...
export default function Home() {
  ...
  const suggestedAction = useMemo(() => {
    ...
    if (last.category === 'Contas') return 'Agende seus pagamentos para manter o histórico organizado e previsível.';
    return 'Use atalhos para registrar novas ações e ver o extrato inteligente em tempo real.';
  }, [transactions]);
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <QuickActionCard
            title="Seguro"
            description="Proteção ativa com registro imediato"
            to="/servicos#seguro"
            accent="#0f172a"
          />
          <QuickActionCard
